...
- `documentation/` - Markdown, localization, and documentation maintenance guidance

## Notes

- Filenames are preserved from `INSTRUCTIONS/`.
- Subfolders group related topics so search can start from the nearest domain.
- This folder is intentionally index-friendly rather than flat.