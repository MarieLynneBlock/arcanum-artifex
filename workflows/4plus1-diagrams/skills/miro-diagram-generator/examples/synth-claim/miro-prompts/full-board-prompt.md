...
2. Create **Frame 1 — Logical view**. Follow the full `logical-view-miro-prompt.md` spec.

3. Create **Frame 2 — Process view (Flow 1: Portal auto-approve)**. Follow `process-view-miro-prompt.md`. Add a note at the bottom: "See frames 2a–2d for the other process flows (email, broker, uncertainty, mainframe-outage, DSAR)." Create these additional frames on a reduced-detail basis if time permits.

4. Create **Frame 3 — Development view**. Follow `development-view-miro-prompt.md`.

5. Create **Frame 4 — Physical view**. Follow `physical-view-miro-prompt.md`.

6. Create **Frame 5 — Scenarios overview**, and Frames 6–12 for individual scenarios S1–S7, and Frame 13 for the coverage matrix. Follow `scenarios-view-miro-prompt.md` for all these.
...
- **1 Logical-view frame** as per `logical-view-miro-prompt.md`
- **1 primary Process-view frame** (Flow 1) + up to 4 additional reduced-detail process frames for the other flows
- **1 Development-view frame** as per `development-view-miro-prompt.md`
- **1 Physical-view frame** as per `physical-view-miro-prompt.md`
- **1 Scenarios-overview frame** + **7 scenario-detail frames** (S1–S7) + **1 coverage-matrix frame** as per `scenarios-view-miro-prompt.md`
