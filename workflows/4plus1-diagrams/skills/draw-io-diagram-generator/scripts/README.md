...
Utility scripts for working with `.drawio` diagram files in the 4plus1-diagrams workflow bundle.
...
```bash
python scripts/validate-drawio.py skills/draw-io-diagram-generator/assets/templates/flowchart.drawio
```
