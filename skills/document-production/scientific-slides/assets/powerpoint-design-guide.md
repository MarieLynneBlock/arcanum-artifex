...
- **Main documentation**: `skills/document-production/pptx/SKILL.md`
...
- `skills/document-production/pptx/SKILL.md`: Main documentation
- `skills/document-production/pptx/html2pptx.md`: HTML to PPTX workflow
- `skills/document-production/pptx/ooxml.md`: Advanced editing
- `skills/document-production/pptx/scripts/`: Utility scripts
