...
See `skills/document-production/pptx/SKILL.md` for complete PPTX creation documentation.
...
**Reference**: See `skills/document-production/pptx/SKILL.md` for complete documentation
...
python ../document-production/pptx/scripts/thumbnail.py presentation.pptx review/thumb
```
...
python ../document-production/pptx/scripts/thumbnail.py presentation.pptx review/grid
```
...
From `skills/document-production/pptx/scripts/`:
...
See `skills/document-production/pptx/SKILL.md` for complete PowerPoint workflow.
