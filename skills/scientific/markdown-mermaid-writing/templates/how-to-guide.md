...
4. Add [Mermaid diagrams](../mermaid-style-guide.md) for process overviews, decision points, or architecture context
...
- **[Next tutorial]** — [What it covers and why you'd want to do it next](../workflow-guide.md)
- **[Reference docs]** — [Where to learn the full feature set](../markdown-style-guide.md)
