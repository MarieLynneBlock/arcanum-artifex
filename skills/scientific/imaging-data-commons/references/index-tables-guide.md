...
For SQL query examples (filter discovery, finding annotations, size estimation), see `references/sql-patterns.md`.
...
For complete query examples using these joins, see `references/sql-patterns.md`.
...
- Complete index table documentation: https://idc-index.readthedocs.io/en/latest/indices_reference.html
- `references/sql-patterns.md` for query examples using these tables
- `references/clinical-data-guide.md` for clinical data workflows
- `references/digital-pathology-guide.md` for pathology-specific indices
