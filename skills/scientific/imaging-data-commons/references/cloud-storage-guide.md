...
For querying version-specific metadata, BigQuery provides versioned tables. See `bigquery-guide.md` for details.
...
**Related Guides:**
- `dicomweb-guide.md` - DICOMweb API access (alternative to direct bucket access)
- `bigquery-guide.md` - Advanced metadata queries including versioned datasets
