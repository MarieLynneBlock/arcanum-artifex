...
For table schemas, DataFrame access, and join column references, see `references/index-tables-guide.md`.
...
client.sql_query("""
    ...
    LIMIT 10
""")
# See references/digital-pathology-guide.md for AnnotationGroupLabel filtering, SM+ANN joins, and more
```
...
See `references/digital-pathology-guide.md` for SM queries, ANN filtering patterns, SM+ANN cross-references, and join examples.
...
See `references/clinical-data-guide.md` for complete patterns including value mapping and patient cohort selection.
...
- `references/index-tables-guide.md` for table schemas, DataFrame access, and join column references
- `references/clinical-data-guide.md` for clinical data patterns and value mapping
- `references/digital-pathology-guide.md` for pathology-specific queries
- `references/bigquery-guide.md` for advanced queries requiring full DICOM metadata
