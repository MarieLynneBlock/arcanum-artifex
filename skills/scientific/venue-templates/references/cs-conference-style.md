...
- `venue-writing-styles.md` - Master style overview
- `ml-conference-style.md` - NeurIPS/ICML style guide
- `conferences-formatting.md` - Technical formatting requirements
- `reviewer-expectations.md` - What CS reviewers seek
