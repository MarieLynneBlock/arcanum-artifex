...
- [Search Best Practices](search-best-practices.md) - For finding URLs to extract
- [Deep Research Guide](deep-research-guide.md) - For comprehensive research tasks
- [Workflow Recipes](workflow-recipes.md) - Common multi-step patterns
