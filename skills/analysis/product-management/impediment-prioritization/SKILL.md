---
name: impediment-prioritisation
...
metadata:
  ...
  created: "2026-04-19"
  updated: "2026-04-21"
  framework: value-stream-prioritisation
  domain: general
---
...
- Never fabricate context (team size, budget, tool inventory, organisational constraints). If required, ask the user or mark the score as estimated.
