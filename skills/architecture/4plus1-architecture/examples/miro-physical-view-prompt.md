...
- **Iteration.** After generation, use the edit function to: "Move the Observability section inside the VPC boundary" or "Add a red lock icon (🔒) to the database connection arrow." One change at a time.
