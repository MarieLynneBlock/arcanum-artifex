...
description: 'Generate a complete MCP server implementation optimised for Copilot Studio integration with proper schema constraints and streamable HTTP support'
metadata:
